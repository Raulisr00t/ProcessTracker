        ...
        if (SUCCEEDED(hr) && retCount != 0) {
            ...
            if (SUCCEEDED(hr) && vtProp.vt == VT_UNKNOWN) {
                ...
                if (SUCCEEDED(hr)) {
                    ...
                    VariantInit(&vtName); VariantInit(&vtPID); VariantInit(&vtPPID); VariantInit(&vtExePath);
                    ...
                    if (vtName.vt == VT_BSTR && vtPID.vt == VT_I4) {
                        ...
                        if (_stricmp(filter, "ALL") == 0 || _stricmp(filter, procName) == 0) {
                            ...
                            wprintf(L"[CREATE] [TIME] => %s  %-25s PID: %-5d PPID: %-7d ParentProcessName: %-20s EXE: %s %s\n",
                                wTime,
                                vtName.bstrVal,
                                vtPID.intVal,
                                vtPPID.intVal,
                    ...
                    VariantClear(&vtName); VariantClear(&vtPID); VariantClear(&vtPPID); VariantClear(&vtExePath);
                ...
                if (SUCCEEDED(hr)) {
                    ...
                    if (vtName.vt == VT_BSTR && vtPID.vt == VT_I4) {
                        ...
                        if (_stricmp(filter, "ALL") == 0 || _stricmp(filter, procName) == 0) {
                            ...
                            wprintf(L"[TERMINATE] [TIME] => %s  %-25s PID: %-5d PPID: %-7d ParentProcessName: %-20s EXE: %s\n",
                                wTime,
                                vtName.bstrVal,
                                vtPID.intVal,
                                vtPPID.intVal,
