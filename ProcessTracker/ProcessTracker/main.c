            ...
            if (SUCCEEDED(hr) && vtProp.vt == VT_UNKNOWN && vtProp.punkVal != NULL) {
                ...
                if (SUCCEEDED(hr)) {
                    ...
                    if (SUCCEEDED(hr) && vtName.vt == VT_BSTR && vtPID.vt == VT_I4 && vtPPID.vt == VT_I4) {
                        ...
                        wprintf(L"[CREATE] Process: %s (PID: %d) | Parent PID: %d | Parent Name: %s\n",
                            vtName.bstrVal, vtPID.intVal, vtPPID.intVal, parentName);
            ...
            if (SUCCEEDED(hr) && vtProp.vt == VT_UNKNOWN && vtProp.punkVal != NULL) {
                ...
                if (SUCCEEDED(hr)) {
                    ...
                    if (SUCCEEDED(hr) && vtName.vt == VT_BSTR && vtPID.vt == VT_I4) 
                        wprintf(L"[TERMINATE] Process: %s (PID: %d)\n", vtName.bstrVal, vtPID.intVal);
